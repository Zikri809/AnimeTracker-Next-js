...
function more(){
        ...
        useEffect(()=>{
            const apilink = 'https://api.jikan.moe/v4/seasons/'+seasoninfo.past_year+'/'+seasoninfo.past_season+'?'
            const storageidentifier = 'lastseason'
            const storagetimeidentifier = 'lastseasontime'
