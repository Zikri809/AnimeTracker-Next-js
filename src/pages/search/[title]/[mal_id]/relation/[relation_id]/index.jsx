    ...
    return (
        <body className='relative overflow-x-hidden top-0 left-0   m-0   w-screen h-auto  bg-black text-white font-poppins my-1 antialiased' >
            ...
            <div className='relative top-20 flex pb-38 sm:pb-30 flex-col '>
               ...
               :<p ref={synopsis_ref}  className='relative text-justify max-h-30 z-1 line-clamp-5'>
                    {animeinfo.synopsis}
               ...
               <div className='bg-neutral-900 px-5 py-4 flex flex-col gap-10 '>
                    ...
                    <Add_to_watchlist_button to={router.asPath.split('/')[1]=='morethiseseason' || router.asPath.split('/')[1]=='moreupcoming' || router.asPath.split('/')[1]=='morelastseason'?(router.query.hasOwnProperty('relation_id')?'/'+router.asPath.split('/')[1]+'/'+router.query.mal_id+'/relation/'+router.query.relation_id+'/tracking':'/'+router.asPath.split('/')[1]+'/'+router.query.mal_id+'/tracking'):(router.query.hasOwnProperty('title')?(router.query.hasOwnProperty('relation_id')?'/search/'+router.query.title+'/'+router.query.mal_id+'/relation/'+router.query.relation_id+'/tracking':'/search/'+router.query.title+'/'+router.query.mal_id+'/tracking'):(router.query.hasOwnProperty('mylist_tab')?'/mylist/'+router.query.mylist_tab+'/'+router.query.mal_id+'/tracking':'/'+router.query.mal_id+'/tracking'))}/>{/* */}
            </div>
