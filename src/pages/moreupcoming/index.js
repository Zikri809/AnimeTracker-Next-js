...
function more(){
        ...
        useEffect(()=>{
                ...
                const apilink = 'https://api.jikan.moe/v4/seasons/'+seasoninfo.upcoming_year+'/'+seasoninfo.upcoming_season+'?'
                const storageidentifier = 'moreupcoming'
                const  storagetimeidentifier = 'moreupcomingtime'
