...
interface NumberedCarouselProps {
  apiref: (api: any) => void;
  length: number;
  componenetid?: string;
}

export default function NumberedCarousel(props: NumberedCarouselProps) {
  return (
    <Carousel
      setApi={props.apiref}
      opts={{
      ...
      id={props.componenetid}
      className="embla w-full border-blue-600 border-0 h-20 py-4"
    >
