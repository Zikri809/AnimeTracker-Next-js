...
function LastSeason(props: SeasonSectionProps) {
    ...
    <section className="mb-8">
      <div className="mb-3 flex flex-row items-end justify-between px-4 sm:px-6">
        <div className="space-y-2">
          <h4 className="scroll-m-20 text-xl font-semibold tracking-tight text-white">Last Season</h4>
          <div className="section-title-rule" />
        </div>
        <Link href={'/morelastseason'}>
