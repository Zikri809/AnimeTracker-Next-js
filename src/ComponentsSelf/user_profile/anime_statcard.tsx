...
interface AnimeStatCardProps {
    data: StatData;
}

export default function AnimeStatCard(props: AnimeStatCardProps) {
        ...
        <Card className='w-auto h-auto text-white bg-neutral-900 border-1 border-neutral-600'>
            <CardContent className='w-auto h-auto'>
                ...
                <CardDescription className='text-neutral-400 sm:justify-center'>
                    ...
                    <Progress className='my-2 h-2 bg-neutral-600 border-0' value={stat_data.mean_score * 10} />
                    <div className="flex flex-row justify-between">
                        <p>Count:</p>
                    ...
                    <div className="my-2 h-[1px] bg-neutral-400"></div>
                    {
                        watchstat.map((element) => (
                            <div key={element.category} className="flex flex-row justify-between">
