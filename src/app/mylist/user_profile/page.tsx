...
export default function UserProfile() {
    ...
    const [joined_date, Set_joined_date] = useState<any>({ year: 'N/A', month: 'N/A', day: 'N/A' });
    ...
    useEffect(() => {
        ...
        fetchAuthSession().then(async (session) => {
            ...
            try {
                ...
                console.error('Failed to fetch fresh user data, falling back to session cache:', e);
            }
        ...
        <div className="bg-black min-h-screen text-white">
            ...
            {loading ? (
                ...
                <div className="flex flex-col gap-4 mx-4 items-center justify-center h-[70svh] relative top-20 text-center">
                    ...
                    <p className="text-neutral-400 text-sm max-w-md">Connect your MyAnimeList account to view your user profile and stats.</p>
                    <Link href="/mylist/login" className="mt-4">
                        <Button className="bg-neutral-700 hover:bg-neutral-600">Go to Login</Button>
                    </Link>
                </div>
            )}
        </div>
